...
print('=' * 60)
print('DX-PINN v2: DRSN + Sparse Attention Screening')
print('Params: ~825K | DRSN adaptive shrinkage + 1.5-entmax')
print('=' * 60)
sys.stdout.flush()
...
sep = '=' * 60
print(f'\n{sep}')
print(f'DX-PINN v2: 10-Run Validation (lr={best_lr})')
print(sep)
sys.stdout.flush()
...
for run in range(10):
    ...
    c, m4, m10, best = train_v2(run, best_lr)
    rc.append(c); r4.append(m4); r10.append(m10); r10b.append(best)
    print(f'Clean={c:.4f} -4dB={m4:.4f} -10dB={m10:.4f} (best={best:.4f})')

print(f'\n{sep}')
print('DX-PINN v2 (100ep) vs Baselines -- CWRU 1HP')
print(sep)
print(f'{"Model":<22} {"-10dB":>16} {"-4dB":>12} {"Clean":>10}')
print(f'{"-"*60}')
print(f'{"v2 DRSN+Sparse 100ep":<22} {np.mean(r10)*100:>7.2f}%+/-{np.std(r10)*100:.2f}% {np.mean(r4)*100:>7.2f}% {np.mean(rc)*100:>7.2f}%')
print(f'{"Lite 100ep":<22} {"69.03%+/-3.62%":>16} {"94.47%":>12} {"99.13%":>10}')
print(f'{"Original 100ep":<22} {"66.70%+/-6.59%":>16} {"93.62%":>12} {"99.71%":>10}')
print(f'{"Original 200ep":<22} {"76.76%+/-1.97%":>16} {"98.41%":>12} {"99.84%":>10}')
print(f'{"MS-TCANet paper":<22} {"74.67%+/-1.24%":>16} {"96.36%":>12} {"~100%":>10}')
print(sep)
